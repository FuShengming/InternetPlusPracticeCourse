...
/**
 * <p>getGroupInfoByMemberNameParamType complex type的 Java 类。
 * 
...
@XmlType(name = "getGroupInfoByMemberNameParamType", propOrder = {
    "memberName"
})
public class GetGroupInfoByMemberNameParamType {
